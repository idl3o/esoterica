...
def cmd_explore():
    ...
    sections = {
        'D': repo_root.parent / 'corpus' / 'distillations',
        'S': repo_root.parent / 'corpus' / 'synthesis',
        'F': repo_root.parent / 'corpus' / 'distillations',  # Fiction bridges are in distillations
        'P': repo_root.parent / 'corpus' / 'protocols',
        'C': repo_root.parent / 'corpus' / 'correspondences'
    }
...
def cmd_random():
    ...
    all_docs = []
    for pattern in ['corpus/distillations/*.md', 'corpus/synthesis/*.md']:
        all_docs.extend(repo_root.parent.glob(pattern))
