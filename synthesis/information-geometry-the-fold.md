...
> *Update (2026-07-02): this document's central bet has since been vindicated by fundamental physics — see [The Arrow on the Surface](cosmology/the-arrow-on-the-surface.md). The rigorous proof of the Bekenstein bound (Casini 2008 → the 2025 crossed-product proof) shows the bound **is** the positivity of a relative entropy — the vacuum-subtracted `S_rel(φ‖ω) ≥ 0`. Relative entropy is KL divergence: the exact **asymmetric, directed** object this document staked everything on, insisting the arrow must not be symmetrized away. The deepest available proof of the corpus's own surface-ontology runs on the arrow. The corrective document was predictive, not merely defensive.*
