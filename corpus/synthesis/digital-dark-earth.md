...
1. **Immature Biosphere** — early Earth. Microbes. Few global feedbacks.
2. **Mature Biosphere** — 2.5 billion to 540 million years ago. Vegetation, photosynthesis, ozone. Strong biosphere-geosphere coupling. Gaia operational.
3. **Immature Technosphere** — **Earth now.** Interlinked systems of communication, transportation, technology, electricity, computation. But "not integrated into other Earth systems." The technosphere draws from Earth's systems in ways that will drive the whole into a new state "that likely does not include the technosphere itself."
4. **Mature Technosphere** — the goal. Technological systems co-evolved with the biosphere, both thriving. Deliberate planetary self-regulation.
